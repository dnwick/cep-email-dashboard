...
$(document).ready(function() {
	...
	$("#emailMonitorConfigForm").submit(function(event){
		...
		//Retrieve form data
		var esbUsername=$("#esbUserName").val();
		var esbPssword=$("#esbPassword").val();
		
		if(esbUsername=="" || esbPssword==""){
			bootbox.alert("Please check values provided for input parameters!");
		}
		else{
			
			var win=window.open("authorize", "windowname1", 'width=800, height=600'); 
			
			
			 var pollTimer=window.setInterval(function() { 
				
			           
				 if (win.document.URL.indexOf("https://localhost:9443/emailMonitor-1.0.0/oauth") != -1) {
