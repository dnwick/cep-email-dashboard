...
public class EmailMonitorConstants {
    ...
    public static final String GMAIL_CLIENT_ID = "GMAICLIENTID";
    public static final String GMAIL_CLIENT_SECRET = "GMAILCLIENTSECRET";
    public static final String GMAIL_REFRESH_TOKEN = "GMAILREFRESHTOKEN";
