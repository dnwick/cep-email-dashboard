...
public final class GmailConstants {
    ...
    /**
     * Name of the "OAuth refresh token" parameter in synapse configuration.
     */
    public static final String GMAIL_PARAM_OAUTH_REFRESH_TOKEN = "oauthRefreshToken";

    /**
     * Name of the "OAuth Client Id" parameter in synapse configuration.
     */
    public static final String GMAIL_PARAM_OAUTH_CLIENT_ID = "oauthClientId";

    /**
     * Name of the "OAuth Client Secret" parameter in synapse configuration.
     */
    public static final String GMAIL_PARAM_OAUTH_CLIENT_SECRET = "oauthClientSecret";
    ...
    /**
     * Property name to store the OAuth2 refersh token of the user to refresh access token.
     */
    public static final String GMAIL_OAUTH_REFRESH_TOKEN = "gmail.oauth.refreshToken";

    /**
     * Property name to store the OAuth2 client id of the user to refresh access token.
     */
    public static final String GMAIL_OAUTH_CLIENT_ID = "gmail.oauth.clientId";

    /**
     * Property name to store the OAuth2 granttype to refresh access token.
     */
    public static final String GMAIL_OAUTH_GRANT_TYPE = "refresh_token";

    /**
     * Property name to store the OAuth2 client secret of the user to refresh access token.
     */
    public static final String GMAIL_OAUTH_CLIENT_SECRET = "gmail.oauth.clientSecret";
    ...
    /**
     * Oauth token validation url
     */
    public static final String GMAIL_OAUTH_VALIDATION_URL = "https://www.googleapis.com/oauth2/v1/tokeninfo";

    /**
     * Oauth token refresh url
     */
    public static final String GMAIL_OAUTH_TOKEN_REFRESH_URL = "https://accounts.google.com/o/oauth2/token?";
}
