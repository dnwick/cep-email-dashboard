...
public class GmailConfig extends AbstractConnector {
	...
	public void connect(MessageContext messageContext) throws ConnectException {
		try {
			...
			this.storeOauthUserLogin(messageContext, username, oauthAccessToken,oauthRefreshToken,oauthClientId,oauthClientSecret);
	...
	private void storeOauthUserLogin(MessageContext messageContext, String username,
	                                 String oauthAccessToken,String oauthRefreshToken,String oauthClientId,String oauthClientSecret) throws MessagingException, Exception {
		...
		if(prestoredAccessToken != null){
			...
			if(((String)prestoredUsername).equals(username)){
				...
				//check whether the prestored accesstoken is valid
				//int responseStatusCode=GmailUtils.validateAccessToken((String)prestoredAccessToken);
